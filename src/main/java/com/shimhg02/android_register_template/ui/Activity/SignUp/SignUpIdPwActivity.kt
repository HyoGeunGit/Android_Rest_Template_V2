...
import kotlinx.android.synthetic.main.activity_signup_idpw.chk_tv
import kotlinx.android.synthetic.main.activity_signup_idpw.pw_chk_tv
import kotlinx.android.synthetic.main.activity_signup_idpw.pw_tv
...
class SignUpIdPwActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        next_btn.setBackgroundResource(R.drawable.btn_signup_not_enable)
        onBackPressed()
        ...
        edit.addTextChangedListener(object: TextWatcher {
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                if (pw_tv.text.toString() != pw_chk_tv.text.toString()) {
                    ...
                    next_btn.setBackgroundResource(R.drawable.signup_btn)
                }
            }
        ...
        Client.retrofitService.duplicate(id_tv.text.toString()).enqueue(object :
            ...
            override fun onResponse(call: Call<Void>?, response: Response<Void>?) {
                when (response!!.code()) {
                    ...
                    500 -> Toast.makeText(this@SignUpIdPwActivity, "서버 점검중입니다. 잠시 후 다시 시도해 주세요.", Toast.LENGTH_LONG).show()
                }
            }
